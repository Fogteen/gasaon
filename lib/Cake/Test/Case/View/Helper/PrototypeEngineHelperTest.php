 ...
 */
	public function testEvent() {
		...
		$result = $this->Proto->event('click', 'Elements.hide(this);', array('stop' => false));
		$expected = '$("myLink").observe("click", function (event) {Elements.hide(this);});';
		$this->assertEquals($expected, $result);

		$result = $this->Proto->event('click', 'Elements.hide(this);');

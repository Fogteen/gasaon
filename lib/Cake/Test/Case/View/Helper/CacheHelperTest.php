 ...
 */
	public function testComplexNoCache() {
		...
		$this->assertRegExp('/B\. In Plain Elements/', $result);
		$this->assertRegExp('/C\. Layout After Test Elements/', $result);
		$this->assertRegExp('/D\. In View File/', $result);
		$this->assertRegExp('/E\. Layout After Content/', $result);
		$this->assertRegExp('/F\. In Elements With No Cache Tags/', $result);
		$this->assertRegExp('/G\. Layout After Content And After Elements With No Cache Tags/', $result);
		...
		$this->assertNotRegExp('/B\. In Plain Elements/', $contents);
		$this->assertRegExp('/C\. Layout After Test Elements/', $contents);
		$this->assertRegExp('/D\. In View File/', $contents);
		$this->assertRegExp('/E\. Layout After Content/', $contents);
		$this->assertRegExp('/F\. In Elements With No Cache Tags/', $contents);
		$this->assertRegExp('/G\. Layout After Content And After Elements With No Cache Tags/', $contents);

 ...
 * @param array $data Array of data to be made available to the rendered view (i.e. the Elements)
 ...
 */
	public function element($name, $data = array(), $options = array()) {
		...
		if (empty($options['ignoreMissing'])) {
			...
			trigger_error(__d('cake_dev', 'Elements Not Found: %s', $file), E_USER_NOTICE);
		}
	}
 ...
 *
 * @param string $file Elements file path

<div class="admins index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('picture_dir'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['social_id']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['picture']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['picture_dir']); ?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('New Ebook'), array('controller' => 'ebooks', 'action' => 'add')); ?> </li>
		...
		<li><?php echo $this->Html->link(__('List Nofications'), array('controller' => 'nofications', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Nofication'), array('controller' => 'nofications', 'action' => 'add')); ?> </li>
		...
		<li><?php echo $this->Html->link(__('New Friend1'), array('controller' => 'friends', 'action' => 'add')); ?> </li>
	</ul>
</div>
